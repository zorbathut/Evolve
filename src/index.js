...
export function index(){
    ...
    let settings = $(`<b-tab-item id="settings" class="settings sticky">
		...
		<b-switch class="setting" v-model="s.qConsume"><span class="settings17" aria-label="${loc('settings17')}">{{ 'q_consume' | label }}</span></b-switch>
        <b-switch class="setting" v-model="s.zCheaty"><span class="settings18" aria-label="${loc('settings18')}">{{ 'z_cheaty' | label }}</span></b-switch>
